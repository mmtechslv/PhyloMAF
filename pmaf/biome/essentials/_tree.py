...
T = TypeVar('T', bound='RepPhylogeny')
...
class RepPhylogeny(EssentialBackboneBase, EssentialFeatureMetabase):
    ...
    def __init__(self,
        ...
        Args:
            ...
            copy: Whether to copy the original tree. May require long time if tree is large.
    ...
    def _merge_features_by_map(self,
        ...
        Args:
            ...
            _annotations: New annotations to passed by `essential` class :class:`~pmaf.biome.essentials._taxonomy.RepTaxonomy`
            **kwargs: Compatibility
    ...
    def render_art(self,
                   output_fp: str,
                   annotated: bool = False) -> Any:
        """Renders tree into file.

        Args:
            output_fp: File to render into. File format depends on the extension. For example, .pdf will produce PDF file while .png will produce PNG file.
