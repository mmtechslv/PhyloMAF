...
'r2Rank': {'d':'Domain','k':'Kingdom','p':'Phylum','c':'Class','o':'Order','f':'Family','g':'Genus','s':'Species'},
'r2rank': {'d':'domain','k':'kingdom','p':'phylum','c':'class','o':'order','f':'family','g':'genus','s':'species'},
'rank2r': {'domain':'d','kingdom':'k','phylum':'p','class':'c','order':'o','family':'f','genus':'g','species':'s'},
'rank2Rank': {'domain':'Domain','kingdom':'Kingdom','phylum':'Phylum','class':'Class','order':'Order','family':'Family','genus':'Genus','species':'Species'},
'Rank2r': {'Domain':'d','Kingdom':'k','Phylum':'p','Class':'c','Order':'o','Family':'f','Genus':'g','Species':'s'}}
...
DEFAULT_METADATA = {'study-name':None,'authors':None,'year':None, 'rel-abun-mode': False}

jRegexGG = compile('([kdpcofgs]{1})[_]{2}([^;_]*)[;]?') #Catches both  rank and taxon for greengenes
...
BIOM_TAXONOMY_NAMES = ['taxon', 'taxonomy', 'lineage', 'lineages', 'taxa', 'consensus lineages', 'consensuslineages']
