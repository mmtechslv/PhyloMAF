...
class DockerBackboneMetabase(ABC):
    ...
    @abstractmethod
    def count(self):
        """Return number of elements the Docker contains."""
        pass
...
class DockerTaxonomyMetabase(DockerBackboneMetabase):
    ...
    def get_avail_ranks(self,indices):
        """Return available taxonomic ranks that Docker contains."""
        pass
...
class DockerPhylogenyMetabase(DockerBackboneMetabase):
    ...
    def get_node_names(self, indices):
        """Return node names/labels of the tree that Docker contains."""
        pass
...
class DockerAccessionMetabase(DockerBackboneMetabase):
    ...
    @abstractmethod
    def sources(self):
        """Return the all unique sources that of accession numbers that this Docker contains."""
        pass
